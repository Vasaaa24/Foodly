...
export const MENU_ITEMS = [
  // Předkrmy
  {
    ...
    detailDescription:
      "Prémiové hovězí maso nakrájené na tenké plátky, podávané na lůžku čerstvé rukoly. Dozdobeno hoblinkami parmazánu, olivovým olejem extra virgin, citronovou šťávou a černým pepřem. Obsahuje: lepek, mléko. Hmotnost: 120g.",
    price: 189,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Křupavý domácí chléb potřený aromatickým česnekovým máslem s čerstvými bylinkami (petržel, oregano, bazalka). Pečený v troubě do zlatova. Obsahuje: lepek, mléko. Hmotnost: 200g. Servírovaný teplý.",
    price: 89,
  ...
  },
  {
    ...
    detailDescription:
      "Šťavná kuřecí křídélka marinovaná 24 hodin v bylinkách a kořeních. Grilovaná do křupava a podávaná s výběrem domácích omáček: BBQ, buffalo, honey mustard, česneková. Obsahuje: lepek (v některých omáčkách). Hmotnost: 400g (8 ks).",
    price: 159,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Pravá mozzarella obalená v křupavé strouhance a smažená v oleji. Podáváná s domácí marinara omáčkou z rajčat, česneku a italských bylinek. Obsahuje: lepek, mléko, vejce. Hmotnost: 180g (6 ks). Servírováno ihned po usmažení.",
    price: 129,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Zralé avokádo rozmačkané s limetkou, solí a černým pepřem, namazané na grilovaný sourdough chléb. Dozdobeno cherry rajčátky, červenou cibulí a chilli vločkami. Obsahuje: lepek. Hmotnost: 250g (2 ks). Vegan možnost.",
    price: 139,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Trio grilovaných chlebů s třemi různými toppingy: 1) Klasická s rajčaty, bazalkou a česnekem, 2) Olivová s černými olivami a bylinkami, 3) Kozí sýr s medem a ořechy. Obsahuje: lepek, mléko, ořechy. Hmotnost: 300g (6 ks).",
    price: 149,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Krémový hummus z cizrny, tahini, citronu a česneku, podávaný s teplou grilovanou pitou a čerstvou zeleninou (mrkev, celer, papriky). Dozdoben olivovým olejem a paprikou. Obsahuje: lepek, sezam. Hmotnost: 280g. Vegan.",
    price: 119,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Prémiový norský losos nakrájený na kostičky, smíchaný s avokádem, červenou cibulí, kapary a citronovou šťávou. Dozdoben kaviárem a podáván s tousty. Obsahuje: lepek, ryby. Hmotnost: 150g. Servírováno čerstvé a chlazené.",
    price: 199,
    image:
  ...
  // Hlavní jídla
  {
    ...
    detailDescription:
      "Prémiový hovězí steak (200g) z mladého býka, grilovaný podle přání (rare, medium-rare, medium, well-done). Na výběr přílohy: hranolky, pečené brambory, rýže nebo grilovaná zelenina. Podáváno s bylinkovou omáčkou. Obsahuje: mléko (v omáčce). Čas přípravy: 15-20 min.",
    price: 349,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Klasická italská pizza na křupavém těstě (výběr: klasické, celozrnné, tenké). Domácí rajčatová omáčka, mozzarella di bufala, čerstvá bazalka a olivový olej. Velikosti: 24cm, 30cm, 36cm. Obsahuje: lepek, mléko. Čas přípravy: 12-15 min. Možnost vegan sýra.",
    price: 189,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Filet norského lososa (180g) grilovaný na olivovém oleji s bylinkami. Podáváno s novými bramborami s máslem a petrželí a směsí sezonní zeleniny (brokolice, mrkev, cuketa). Obsahuje: ryby, mléko. Bohatý na omega-3 mastné kyseliny. Čas přípravy: 12-15 min.",
    price: 329,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Šťavné kuřecí prso (200g) marinované v bylinkách a grilované do zlatova. Podáváno s jasmínovou rýží a výběrem omáčky: smetanová houbová, teriyaki nebo česneková. Obsahuje: mléko (v některých omáčkách). Čas přípravy: 15-18 min.",
    price: 219,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Autentická italská carbonara s čerstvými spaghetti, křupavou anglickou slaninou, organickými vejci a zrajícím parmazánem. Připravená podle tradiční receptury bez smetany. Obsahuje: lepek, mléko, vejce. Hmotnost: 350g. Čas přípravy: 10-12 min.",
    price: 199,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Prémiový hovězí steak z mramorového masa (250g). Grilovaný podle přání s grilovanými bramborami, restovanou zeleninou a demi-glace omáčkou. Obsahuje: mléko. Čas přípravy: 18-25 min podle propečení.",
    price: 389,
    image:
  ...
  // Dezerty
  {
    ...
    detailDescription:
      "Autentické italské tiramisu s čerstvým mascarpone, silnou espresso kávou, savoiardi piškoty a kakao. Výroba trvá 24 hodin pro dokonalé prokreslení chutí. Obsahuje: lepek, mléko, vejce, alkohol (marsala). Hmotnost: 120g. Podáváno chlazené.",
    price: 99,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Domácí čokoládový brownie pečený denně, bohatý na belgickou čokoládu a ořechy. Podáváno teplé s kuličkou prémiové vanilkové zmrzliny a čerstvými lesními plody. Obsahuje: lepek, mléko, vejce, ořechy. Hmotnost: 150g + 50g zmrzlina.",
    price: 109,
    image:
  ...
  // Nápoje
  {
    ...
    detailDescription:
      "Originální Coca-Cola v skleněné lahvi nebo z automatu. Perfektně chlazená, s ledem a citronem na přání. Obsahuje kofein a cukr. Objem: 0,33l nebo 0,5l. Bez konzervantů. Možnost verze Zero nebo Light.",
    price: 45,
    image:
  ...
  },
  {
    ...
    detailDescription:
      "Český ležák Pilsner Urquell z tankového piva. Čerstvě načepováno s dokonalou pěnou. Alkohol: 4,4%. Objem: 0,3l nebo 0,5l. Podáváno v chlazené sklenici při teplotě 6-8°C. Ke konzumaci pouze osobám starším 18 let.",
    price: 59,
    image:
